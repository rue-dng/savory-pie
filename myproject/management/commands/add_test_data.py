...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        inner = models.InnerThing(name_i='Alpha'); inner.save()
        middle = models.MiddleThing(name_m='Bravo', inner=inner); middle.save()
        outer = models.OuterThing(name_o='Charlie', middle=middle); outer.save()
